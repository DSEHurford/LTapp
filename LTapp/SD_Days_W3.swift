...
struct SD_Days_W3: View {
    var body: some View {
        NavigationView{
            VStack(alignment: .leading, spacing: 0.0){
                Group{
                NavigationLink(destination:SD_Monday_W3()){
                ...
                Spacer()
                    .frame(height: 15.0)
                NavigationLink(destination:SD_Tuesday_W3()){
                ...
                Spacer()
                    .frame(height: 15.0)
                NavigationLink(destination:SD_Wednesday_W3()){
                ...
                Spacer()
                    .frame(height: 15.0)
                NavigationLink(destination:SD_Thursday_W3()){
                ...
                Spacer()
                    .frame(height: 15.0)
                NavigationLink(destination:SD_Friday_W3()){
                ...
                Spacer()
                    .frame(height: 15.0)
                NavigationLink(destination:SD_Sunday_W3()){
...
struct SD_Days_W3_Previews: PreviewProvider {
