...
struct LongQs_Sunday_W2: View {
    @AppStorage("1W2") private var questionIndex1W2 = 0
    @AppStorage("2W2") private var questionIndex2W2 = 0
    @AppStorage("3W2") private var questionIndex3W2 = 0
    @AppStorage("4W2") private var questionIndex4W2 = 0
    @AppStorage("5W2") private var questionIndex5W2 = 0
    @AppStorage("6W2")  private var questionIndex6W2 = 0
    @AppStorage("7W2")  private var questionIndex9W2 = 0
    @AppStorage("8W2")  private var questionIndex10W2 = 0
    @AppStorage("9W2")  private var questionIndex11W2 = 0
    @AppStorage("10W2")  private var questionIndex12W2 = 0
    @AppStorage("11W2")  private var questionIndex13W2 = 0
    @AppStorage("12W2")  private var questionIndex14W2 = 0
    @AppStorage("13W2")  private var questionIndex15W2 = 0
    @AppStorage("14W2")  private var questionIndex16W2 = 0
            ...
            Form{
                Group{
                    Section{
                        HStack{
                            ...
                            Picker(selection: $questionIndex1W2, label: Text("Falling Asleep")){
                    ...
                    Section{
                        HStack{
                            Image(systemName: "bed.double").foregroundColor(Color("Color-1")).font(.system(size:15))
                            Picker(selection: $questionIndex2W2, label: Text("Sleep During the Night")){
                    ...
                    Section{
                        HStack{
                            Image(systemName: "bed.double").foregroundColor(Color("Color-1")).font(.system(size:15))
                            Picker(selection: $questionIndex3W2, label: Text("Waking Up Too Early")){
                    ...
                    Section{
                        HStack{
                            Image(systemName: "bed.double").foregroundColor(Color("Color-1")).font(.system(size:15))
                            Picker(selection: $questionIndex4W2, label: Text("Sleeping Too Much")){
                    ...
                    Section{
                        ...
                        Image(systemName: "cloud.sun").foregroundColor(Color("Color-1")).font(.system(size:15))
                            Picker(selection: $questionIndex5W2, label: Text("Feeling Sad")){
                    ...
                    Section{
                        HStack{
                            ...
                            Picker(selection: $questionIndex6W2, label: Text("Decreased/Increased Appetite")){
                ...
                Group{
                    Section{
                        HStack{
                            Image(systemName: "heart").foregroundColor(Color("Color-1")).font(.system(size:15))
                            Picker(selection: $questionIndex9W2, label: Text("Decreased/Increased Weight")){
                    ...
                    Section{
                        HStack{
                            ...
                            Picker(selection: $questionIndex10W2, label: Text("Concentration/Decision Making")){
                    ...
                    Section{
                        HStack{
                            ...
                            Picker(selection: $questionIndex11W2, label: Text("View of Myself")){
                    ...
                    Section{
                        HStack{
                            ...
                            Picker(selection: $questionIndex12W2, label: Text("Thoughts of Death or Suicide")){
                    ...
                    Section{
                        HStack{
                            ...
                            Picker(selection: $questionIndex13W2, label: Text("General Interest")){
                    ...
                    Section{
                        HStack{
                            ...
                            Picker(selection: $questionIndex14W2, label: Text("Energy Levels")){
                    ...
                    Section{
                        HStack{
                            ...
                            Picker(selection: $questionIndex15W2, label: Text("Feeling Slowed Down")){
                    ...
                    Section{
                        HStack{
                            ...
                            Picker(selection: $questionIndex16W2, label: Text("Feeling Restless")){
...
struct LongQs_Sunday_W2_Previews: PreviewProvider {
