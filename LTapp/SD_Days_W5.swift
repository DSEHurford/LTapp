...
struct SD_Days_W5: View {
    var body: some View {
        NavigationView{
            VStack(alignment: .leading, spacing: 0.0){
                Group{
                NavigationLink(destination:SD_Monday_W5()){
                ...
                Spacer()
                    .frame(height: 15.0)
                NavigationLink(destination:SD_Tuesday_W5()){
                ...
                Spacer()
                    .frame(height: 15.0)
                NavigationLink(destination:SD_Wednesday_W5()){
                ...
                Spacer()
                    .frame(height: 15.0)
                NavigationLink(destination:SD_Thursday_W5()){
                ...
                Spacer()
                    .frame(height: 15.0)
                NavigationLink(destination:SD_Friday_W5()){
                ...
                Spacer()
                    .frame(height: 15.0)
                NavigationLink(destination:SD_Saturday_W5()){
                ...
                Spacer()
                    .frame(height: 15.0)
                NavigationLink(destination:SD_Sunday_W5()){
...
struct SD_Days_W5_Previews: PreviewProvider {
