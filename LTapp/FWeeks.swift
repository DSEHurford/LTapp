...
//  LTapp
//
//  Created by Danielle Hurford on 24/03/2021.
//
            ...
            VStack{
                ...
                NavigationView{
                    ...
                    Group{
                        ...
                        NavigationLink(destination:Week0()){
                            Text("Week 0")
                                .font(.title)
                                .fontWeight(.bold)
                                .cornerRadius(30)
                        ...
                        HStack{
                            ...
                            Spacer()
                            Image(systemName: "circle.fill").foregroundColor(Color("Color-8"))
                            NavigationLink(destination:Feelings_Days_W1()){
                    ...
                    .shadow(color: Color.black.opacity(0.3), radius: 5, x: 0, y:10)
                        ...
                        HStack{
                            Spacer()
                            Image(systemName: "circle.fill").foregroundColor(Color("Color-8"))
                            NavigationLink(destination:Feelings_Day_W2()){
                    ...
                    .shadow(color: Color.black.opacity(0.3), radius: 5, x: 0, y:10)
                        ...
                        HStack{
                            Spacer()
                            Image(systemName: "circle.fill").foregroundColor(Color("Color-8"))
                            NavigationLink(destination:Feelings_Day_W3()){
                    ...
                    .shadow(color: Color.black.opacity(0.3), radius: 5, x: 0, y:10)
                        ...
                        HStack{
                            Spacer()
                            Image(systemName: "circle.fill").foregroundColor(Color("Color-8"))
                            NavigationLink(destination:Feelings_Day_W4()){
                    ...
                    Group{
                        ...
                        HStack{
                            Spacer()
                            Image(systemName: "circle.fill").foregroundColor(Color("Color-8"))
                            NavigationLink(destination:Feelings_Days_W5()){
                    ...
                    .shadow(color: Color.black.opacity(0.3), radius: 5, x: 0, y:10)
                        ...
                        HStack{
                            Spacer()
                            Image(systemName: "circle.fill").foregroundColor(Color("Color-8"))
                            NavigationLink(destination:Feelings_Days_W6()){
                                Text("Week 6")
                                    .font(.title)
                                    .fontWeight(.bold)
                                    .foregroundColor(Color("Color-8"))
...
struct FWeeks_Previews: PreviewProvider {
