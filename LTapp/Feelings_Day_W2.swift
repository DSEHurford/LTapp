...
struct Feelings_Day_W2: View {
    var body: some View {
        NavigationView{
            VStack(alignment: .leading, spacing: 0.0){
                Group{
                NavigationLink(destination:ShortQs_Monday_W2()){
                ...
                Spacer()
                    .frame(height: 15.0)
                NavigationLink(destination:ShortQs_Tuesday_W2()){
                ...
                Spacer()
                    .frame(height: 15.0)
                NavigationLink(destination:ShortQs_Wednesday_W2()){
                ...
                Spacer()
                    .frame(height: 15.0)
                NavigationLink(destination:ShortQs_Thursday_W2()){
                ...
                Spacer()
                    .frame(height: 15.0)
                NavigationLink(destination:ShortQs_Friday_W2()){
                ...
                Spacer()
                    .frame(height: 15.0)
                NavigationLink(destination:ShortQs_Saturday_W2()){
                ...
                Spacer()
                    .frame(height: 15.0)
                NavigationLink(destination:LongQs_Sunday_W2()){
...
struct Feelings_Day_W2_Previews: PreviewProvider {
