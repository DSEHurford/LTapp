...
struct SD_Days_W6: View {
    var body: some View {
        NavigationView{
            VStack(alignment: .leading, spacing: 0.0){
                Group{
                NavigationLink(destination:SD_Monday_W6()){
                ...
                Spacer()
                    .frame(height: 15.0)
                NavigationLink(destination:SD_Tuesday_W6()){
                ...
                Spacer()
                    .frame(height: 15.0)
                NavigationLink(destination:SD_Wednesday_W6()){
                ...
                Spacer()
                    .frame(height: 15.0)
                NavigationLink(destination:SD_Thursday_W6()){
                ...
                Spacer()
                    .frame(height: 15.0)
                NavigationLink(destination:SD_Friday_W6()){
                ...
                Spacer()
                    .frame(height: 15.0)
                NavigationLink(destination:SD_Saturday_W6()){
                ...
                Spacer()
                    .frame(height: 15.0)
                NavigationLink(destination:SD_Sunday_W6()){
...
struct SD_Days_W6_Previews: PreviewProvider {
