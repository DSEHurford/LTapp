...
struct LongQs_Sunday_W6: View {
    @AppStorage("1W6") private var questionIndex1W6 = 0
    @AppStorage("2W6") private var questionIndex2W6 = 0
    @AppStorage("3W6") private var questionIndex3W6 = 0
    @AppStorage("4W6") private var questionIndex4W6 = 0
    @AppStorage("5W6") private var questionIndex5W6 = 0
    @AppStorage("6W6")  private var questionIndex6W6 = 0
    @AppStorage("7W6")  private var questionIndex9W6 = 0
    @AppStorage("8W6")  private var questionIndex10W6 = 0
    @AppStorage("9W6")  private var questionIndex11W6 = 0
    @AppStorage("10W6")  private var questionIndex12W6 = 0
    @AppStorage("11W6")  private var questionIndex13W6 = 0
    @AppStorage("12W6")  private var questionIndex14W6 = 0
    @AppStorage("13W6")  private var questionIndex15W6 = 0
    @AppStorage("14W6")  private var questionIndex16W6 = 0
            ...
            Form{
                Group{
                    Section{
                        HStack{
                            ...
                            Picker(selection: $questionIndex1W6, label: Text("Falling Asleep")){
                    ...
                    Section{
                        HStack{
                            Image(systemName: "bed.double").foregroundColor(Color("Color-1")).font(.system(size:15))
                            Picker(selection: $questionIndex2W6, label: Text("Sleep During the Night")){
                    ...
                    Section{
                        HStack{
                            Image(systemName: "bed.double").foregroundColor(Color("Color-1")).font(.system(size:15))
                            Picker(selection: $questionIndex3W6, label: Text("Waking Up Too Early")){
                    ...
                    Section{
                        HStack{
                            Image(systemName: "bed.double").foregroundColor(Color("Color-1")).font(.system(size:15))
                            Picker(selection: $questionIndex4W6, label: Text("Sleeping Too Much")){
                    ...
                    Section{
                        HStack{
                            ...
                            Picker(selection: $questionIndex5W6, label: Text("Feeling Sad")){
                    ...
                    Section{
                        HStack{
                            ...
                            Picker(selection: $questionIndex6W6, label: Text("Decreased/Increased Appetite")){
                ...
                Group{
                    Section{
                        HStack{
                            Image(systemName: "heart").foregroundColor(Color("Color-1")).font(.system(size:15))
                            Picker(selection: $questionIndex9W6, label: Text("Decreased/Increased Weight")){
                    ...
                    Section{
                        HStack{
                            ...
                            Picker(selection: $questionIndex10W6, label: Text("Concentration/Decision Making")){
                    ...
                    Section{
                        HStack{
                            ...
                            Picker(selection: $questionIndex11W6, label: Text("View of Myself")){
                    ...
                    Section{
                        HStack{
                            ...
                            Picker(selection: $questionIndex12W6, label: Text("Thoughts of Death or Suicide")){
                    ...
                    Section{
                        HStack{
                            ...
                            Picker(selection: $questionIndex13W6, label: Text("General Interest")){
                    ...
                    Section{
                        HStack{
                            ...
                            Picker(selection: $questionIndex14W6, label: Text("Energy Levels")){
                    ...
                    Section{
                        HStack{
                            ...
                            Picker(selection: $questionIndex15W6, label: Text("Feeling Slowed Down")){
                    ...
                    Section{
                        HStack{
                            ...
                            Picker(selection: $questionIndex16W6, label: Text("Feeling Restless")){
...
struct LongQs_Sunday_W6_Previews: PreviewProvider {
