...
struct Qs_Sunday_W1: View {
    @AppStorage("1W1") private var questionIndex1W1 = 0
    @AppStorage("2W1") private var questionIndex2W1 = 0
    @AppStorage("3W1") private var questionIndex3W1 = 0
    @AppStorage("4W1") private var questionIndex4W1 = 0
    @AppStorage("5W1") private var questionIndex5W1 = 0
    @AppStorage("6W1") private var questionIndex6W1 = 0
    @AppStorage("7W1") private var questionIndex9W1 = 0
    @AppStorage("8W1") private var questionIndex10W1 = 0
    @AppStorage("9W1") private var questionIndex11W1 = 0
    @AppStorage("10W1") private var questionIndex12W1 = 0
    @AppStorage("11W1") private var questionIndex13W1 = 0
    @AppStorage("12W1") private var questionIndex14W1 = 0
    @AppStorage("13W1") private var questionIndex15W1 = 0
    @AppStorage("14W1") private var questionIndex16W1 = 0
            ...
            Form{
                Group{
                    Section{
                        HStack{
                            ...
                            Picker(selection: $questionIndex1W1, label: Text("Falling Asleep")){
                    ...
                    Section{
                        HStack{
                            Image(systemName: "bed.double").foregroundColor(Color("Color-1")).font(.system(size:15))
                            Picker(selection: $questionIndex2W1, label: Text("Sleep During the Night")){
                    ...
                    Section{
                        HStack{
                            Image(systemName: "bed.double").foregroundColor(Color("Color-1")).font(.system(size:15))
                            Picker(selection: $questionIndex3W1, label: Text("Waking Up Too Early")){
                    ...
                    Section{
                        HStack{
                            Image(systemName: "bed.double").foregroundColor(Color("Color-1")).font(.system(size:15))
                            Picker(selection: $questionIndex4W1, label: Text("Sleeping Too Much")){
                    ...
                    Section{
                        ...
                        Image(systemName: "cloud.sun").foregroundColor(Color("Color-1")).font(.system(size:15))
                            Picker(selection: $questionIndex5W1, label: Text("Feeling Sad")){
                    ...
                    Section{
                        HStack{
                            ...
                            Picker(selection: $questionIndex6W1, label: Text("Decreased/Increased Appetite")){
                ...
                Group{
                    Section{
                        HStack{
                            Image(systemName: "heart").foregroundColor(Color("Color-1")).font(.system(size:15))
                            Picker(selection: $questionIndex9W1, label: Text("Decreased/Increased Weight")){
                    ...
                    Section{
                        HStack{
                            ...
                            Picker(selection: $questionIndex10W1, label: Text("Concentration/Decision Making")){
                    ...
                    Section{
                        HStack{
                            ...
                            Picker(selection: $questionIndex11W1, label: Text("View of Myself")){
                    ...
                    Section{
                        HStack{
                            ...
                            Picker(selection: $questionIndex12W1, label: Text("Thoughts of Death or Suicide")){
                    ...
                    Section{
                        HStack{
                            ...
                            Picker(selection: $questionIndex13W1, label: Text("General Interest")){
                    ...
                    Section{
                        HStack{
                            ...
                            Picker(selection: $questionIndex14W1, label: Text("Energy Levels")){
                    ...
                    Section{
                        HStack{
                            ...
                            Picker(selection: $questionIndex15W1, label: Text("Feeling Slowed Down")){
                    ...
                    Section{
                        HStack{
                            ...
                            Picker(selection: $questionIndex16W1, label: Text("Feeling Restless")){
...
struct Qs_Sunday_W1_Previews: PreviewProvider {
