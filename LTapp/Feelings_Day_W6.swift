...
struct Feelings_Days_W6: View {
    var body: some View {
        NavigationView{
            VStack(alignment: .leading, spacing: 0.0){
                Group{
                NavigationLink(destination:ShortQs_Monday_W6()){
                ...
                Spacer()
                    .frame(height: 15.0)
                NavigationLink(destination:ShortQs_Tuesday_W6()){
                ...
                Spacer()
                    .frame(height: 15.0)
                NavigationLink(destination:ShortQs_Wednesday_W6()){
                ...
                Spacer()
                    .frame(height: 15.0)
                NavigationLink(destination:ShortQs_Thursday_W6()){
                ...
                Spacer()
                    .frame(height: 15.0)
                NavigationLink(destination:ShortQs_Friday_W6()){
                ...
                Spacer()
                    .frame(height: 15.0)
                NavigationLink(destination:ShortQs_Saturday_W6()){
                ...
                Spacer()
                    .frame(height: 15.0)
                NavigationLink(destination:LongQs_Sunday_W6()){
...
struct Feelings_Day_W6_Previews: PreviewProvider {
