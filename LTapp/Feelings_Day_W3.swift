...
struct Feelings_Day_W3: View {
    var body: some View {
        NavigationView{
            VStack(alignment: .leading, spacing: 0.0){
                Group{
                NavigationLink(destination:ShortQs_Monday_W3()){
                ...
                Spacer()
                    .frame(height: 15.0)
                NavigationLink(destination:ShortQs_Tuesday_W3()){
                ...
                Spacer()
                    .frame(height: 15.0)
                NavigationLink(destination:ShortQs_Wednesday_W3()){
                ...
                Spacer()
                    .frame(height: 15.0)
                NavigationLink(destination:ShortQs_Thursday_W3()){
                ...
                Spacer()
                    .frame(height: 15.0)
                NavigationLink(destination:ShortQs_Friday_W3()){
                ...
                Spacer()
                    .frame(height: 15.0)
                NavigationLink(destination:ShortQs_Saturday_W3()){
                ...
                Spacer()
                    .frame(height: 15.0)
                NavigationLink(destination:LongQs_Sunday_W3()){
...
struct Feelings_Day_W3_Previews: PreviewProvider {
