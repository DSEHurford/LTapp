...
struct Feelings_Days_W1: View {
    var body: some View {
        NavigationView{
            VStack(alignment: .leading, spacing: 0.0){
                Group{
                NavigationLink(destination:LongQs_Monday_W1()){
                ...
                Spacer()
                    .frame(height: 15.0)
                NavigationLink(destination:ShortQs_Tuesday_W1()){
                ...
                Spacer()
                    .frame(height: 15.0)
                NavigationLink(destination:ShortQs_Wednesday_W1()){
                ...
                Spacer()
                    .frame(height: 15.0)
                NavigationLink(destination:ShortQs_Thursday_W1()){
                ...
                Spacer()
                    .frame(height: 15.0)
                NavigationLink(destination:ShortQs_Friday_W1()){
                ...
                Spacer()
                    .frame(height: 15.0)
                NavigationLink(destination:ShortQs_Saturday_W1()){
                ...
                Spacer()
                    .frame(height: 15.0)
                NavigationLink(destination:Qs_Sunday_W1()){
...
struct Feelings_Days_W1_Previews: PreviewProvider {
