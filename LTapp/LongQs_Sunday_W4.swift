...
struct LongQs_Sunday_W4: View {
    @AppStorage("1W4") private var questionIndex1W4 = 0
    @AppStorage("2W4") private var questionIndex2W4 = 0
    @AppStorage("3W4") private var questionIndex3W4 = 0
    @AppStorage("4W4") private var questionIndex4W4 = 0
    @AppStorage("5W4") private var questionIndex5W4 = 0
    @AppStorage("6W4")  private var questionIndex6W4 = 0
    @AppStorage("7W4")  private var questionIndex9W4 = 0
    @AppStorage("8W4")  private var questionIndex10W4 = 0
    @AppStorage("9W4")  private var questionIndex11W4 = 0
    @AppStorage("10W4")  private var questionIndex12W4 = 0
    @AppStorage("11W4")  private var questionIndex13W4 = 0
    @AppStorage("12W4")  private var questionIndex14W4 = 0
    @AppStorage("13W4")  private var questionIndex15W4 = 0
    @AppStorage("14W4")  private var questionIndex16W4 = 0
            ...
            Form{
                Group{
                    Section{
                        HStack{
                            ...
                            Picker(selection: $questionIndex1W4, label: Text("Falling Asleep")){
                    ...
                    Section{
                        HStack{
                            Image(systemName: "bed.double").foregroundColor(Color("Color-1")).font(.system(size:15))
                            Picker(selection: $questionIndex2W4, label: Text("Sleep During the Night")){
                    ...
                    Section{
                        HStack{
                            Image(systemName: "bed.double").foregroundColor(Color("Color-1")).font(.system(size:15))
                            Picker(selection: $questionIndex3W4, label: Text("Waking Up Too Early")){
                    ...
                    Section{
                        HStack{
                            Image(systemName: "bed.double").foregroundColor(Color("Color-1")).font(.system(size:15))
                            Picker(selection: $questionIndex4W4, label: Text("Sleeping Too Much")){
                    ...
                    Section{
                        ...
                        Image(systemName: "cloud.sun").foregroundColor(Color("Color-1")).font(.system(size:15))
                            Picker(selection: $questionIndex5W4, label: Text("Feeling Sad")){
                    ...
                    Section{
                        HStack{
                            ...
                            Picker(selection: $questionIndex6W4, label: Text("Decreased/Increased Appetite")){
                ...
                Group{
                    Section{
                        HStack{
                            Image(systemName: "heart").foregroundColor(Color("Color-1")).font(.system(size:15))
                            Picker(selection: $questionIndex9W4, label: Text("Decreased/Increased Weight")){
                    ...
                    Section{
                        HStack{
                            ...
                            Picker(selection: $questionIndex10W4, label: Text("Concentration/Decision Making")){
                    ...
                    Section{
                        HStack{
                            ...
                            Picker(selection: $questionIndex11W4, label: Text("View of Myself")){
                    ...
                    Section{
                        HStack{
                            ...
                            Picker(selection: $questionIndex12W4, label: Text("Thoughts of Death or Suicide")){
                    ...
                    Section{
                        HStack{
                            ...
                            Picker(selection: $questionIndex13W4, label: Text("General Interest")){
                    ...
                    Section{
                        HStack{
                            ...
                            Picker(selection: $questionIndex14W4, label: Text("Energy Levels")){
                    ...
                    Section{
                        HStack{
                            ...
                            Picker(selection: $questionIndex15W4, label: Text("Feeling Slowed Down")){
                    ...
                    Section{
                        HStack{
                            ...
                            Picker(selection: $questionIndex16W4, label: Text("Feeling Restless")){
...
struct LongQs_Sunday_W4_Previews: PreviewProvider {
