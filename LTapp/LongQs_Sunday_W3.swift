...
struct LongQs_Sunday_W3: View {
    @AppStorage("1W3") private var questionIndex1W3 = 0
    @AppStorage("2W3") private var questionIndex2W3 = 0
    @AppStorage("3W3") private var questionIndex3W3 = 0
    @AppStorage("4W3") private var questionIndex4W3 = 0
    @AppStorage("5W3") private var questionIndex5W3 = 0
    @AppStorage("6W3")  private var questionIndex6W3 = 0
    @AppStorage("7W3")  private var questionIndex9W3 = 0
    @AppStorage("8W3")  private var questionIndex10W3 = 0
    @AppStorage("9W3")  private var questionIndex11W3 = 0
    @AppStorage("10W3")  private var questionIndex12W3 = 0
    @AppStorage("11W3")  private var questionIndex13W3 = 0
    @AppStorage("12W3")  private var questionIndex14W3 = 0
    @AppStorage("13W3")  private var questionIndex15W3 = 0
    @AppStorage("14W3")  private var questionIndex16W3 = 0
    ...
    var body: some View {
        NavigationView{
            Form{
                Group{
                    Section{
                        HStack{
                            ...
                            Picker(selection: $questionIndex1W3, label: Text("Falling Asleep")){
                    ...
                    Section{
                        HStack{
                            Image(systemName: "bed.double").foregroundColor(Color("Color-1")).font(.system(size:15))
                            Picker(selection: $questionIndex2W3, label: Text("Sleep During the Night")){
                    ...
                    Section{
                        HStack{
                            Image(systemName: "bed.double").foregroundColor(Color("Color-1")).font(.system(size:15))
                            Picker(selection: $questionIndex3W3, label: Text("Waking Up Too Early")){
                    ...
                    Section{
                        HStack{
                            Image(systemName: "bed.double").foregroundColor(Color("Color-1")).font(.system(size:15))
                            Picker(selection: $questionIndex4W3, label: Text("Sleeping Too Much")){
                    ...
                    Section{
                        ...
                        Image(systemName: "cloud.sun").foregroundColor(Color("Color-1")).font(.system(size:15))
                            Picker(selection: $questionIndex5W3, label: Text("Feeling Sad")){
                    ...
                    Section{
                        HStack{
                            ...
                            Picker(selection: $questionIndex6W3, label: Text("Decreased/Increased Appetite")){
                ...
                Group{
                    Section{
                        HStack{
                            Image(systemName: "heart").foregroundColor(Color("Color-1")).font(.system(size:15))
                            Picker(selection: $questionIndex9W3, label: Text("Decreased/Increased Weight")){
                    ...
                    Section{
                        Picker(selection: $questionIndex10W3, label: Text("Concentration/Decision Making")){
                    ...
                    Section{
                        HStack{
                            ...
                            Picker(selection: $questionIndex11W3, label: Text("View of Myself")){
                    ...
                    Section{
                        HStack{
                            ...
                            Picker(selection: $questionIndex12W3, label: Text("Thoughts of Death or Suicide")){
                    ...
                    Section{
                        HStack{
                            ...
                            Picker(selection: $questionIndex13W3, label: Text("General Interest")){
                    ...
                    Section{
                        HStack{
                            ...
                            Picker(selection: $questionIndex14W3, label: Text("Energy Levels")){
                    ...
                    Section{
                        HStack{
                            ...
                            Picker(selection: $questionIndex15W3, label: Text("Feeling Slowed Down")){
                    ...
                    Section{
                        HStack{
                            ...
                            Picker(selection: $questionIndex16W3, label: Text("Feeling Restless")){
            ...
            }.navigationBarTitle(Text("Please answer according to the last 7 days"))
        }
...
struct LongQs_Sunday_W3_Previews: PreviewProvider {
